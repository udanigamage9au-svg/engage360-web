...
function Dashboard() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/announcements")
      .then((r) => r.json())
      .then((data) => {
        if (Array.isArray(data)) setAnnouncements(data.slice(0, 3));
      })
      .catch(() => {});
  }, []);
        ...
        <div style={styles.column}>
          ...
          <div style={styles.statsRow}>
            ...
            <div style={styles.glassCardPrimary}>
              ...
              <button style={styles.ghostButton} onClick={() => navigate("/rewards")}>
                View Rewards →
              </button>
            </div>
          ...
          <div style={styles.quickCardsRow}>
            ...
            <div style={styles.actionCard}>
              ...
              <button style={styles.primaryActionBtn} onClick={() => navigate("/explore")}>
                Book a Study Room
              </button>
            </div>
            ...
            <div style={styles.actionCard}>
              ...
              <button style={styles.trackLiveBtn} onClick={() => navigate("/transit")}>
                Track Now
              </button>
            </div>
          </div>
        ...
        <div style={styles.column}>
          ...
          <div>
            ...
            {announcements.length === 0 ? (
              <div style={styles.emptyAnn}>
                <span style={{ fontSize: "28px" }}>📭</span>
                <p style={styles.emptyAnnText}>No announcements yet</p>
              </div>
            ) : (
                  ...
                  <div key={ann.id} style={styles.annCard}>
                    ...
                    <div
                      style={{
                        ...styles.annAccent,
                        background:
                          i === 0 ? "#295fb8" : i === 1 ? "#facc15" : "#10b981",
                      }}
                    />
                    <div style={styles.annBody}>
                      <div style={styles.annTop}>
                        <span style={styles.annTitle}>{ann.title}</span>
                        <span style={styles.annTime}>{timeAgo(ann.created_at)}</span>
                      </div>
                      <p style={styles.annMsg}>
...
const styles = {
  ...
  glassCard: {
    flex: 1, background: "rgba(255,255,255,0.8)", padding: "24px",
    borderRadius: "24px", border: "1px solid rgba(255,255,255,0.4)",
    boxShadow: "0 10px 25px rgba(0,0,0,0.03)", display: "flex",
  ...
  // ── Quick Actions ──
  quickCardsRow: { display: "flex", gap: "20px" },
  actionCard: {
    flex: 1, background: "white", borderRadius: "24px", padding: "20px",
  ...
  // ── Announcements ──
  annList: { display: "flex", flexDirection: "column", gap: "10px" },
  annCard: {
    display: "flex",
    background: "white",
    borderRadius: "14px",
  ...
  annAccent: { width: "5px", flexShrink: 0 },
  annBody: { flex: 1, padding: "12px 14px" },
  annTop: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" },
  annTitle: { fontSize: "13px", fontWeight: "700", color: "#1e293b" },
  annTime: { fontSize: "11px", color: "#94a3b8", whiteSpace: "nowrap", marginLeft: "8px" },
  annMsg: { fontSize: "12px", color: "#64748b", margin: 0, lineHeight: "1.5" },
  viewAllBtn: {
    marginTop: "4px", width: "100%", padding: "10px",
    background: "#eff6ff", color: "#295fb8", border: "none",
  ...
  emptyAnn: {
    ...
    gap: "8px", border: "1px solid #f1f5f9",
  },
  emptyAnnText: { fontSize: "13px", color: "#94a3b8", margin: 0 },
