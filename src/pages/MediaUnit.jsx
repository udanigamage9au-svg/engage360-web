...
<img src={mediaImg} style={styles.image}/>
...
<h3>About the Media Unit</h3>

<p>
The Media Unit provides access to digital media facilities,
editing stations, recording tools and multimedia support
for academic and creative work.
</p>

<p>
Students can use the unit for video production,
presentations, content creation and media-based coursework.
</p>
...
<div style={{...styles.infoCard, position:"relative", zIndex:2}}>
